...
int Keyboard(int& angle1, int& angle2, bool& shoot1, bool& shoot2)
{
	...
	return angle1, angle2, shoot1, shoot2;
};
	...
	int score1 = 0, score2 = 0;
		...
		for (;;)
		{
			...
			while (sound_plane.getStatus() == sf::Sound::Playing)
			{
				...
				if (fabs(plane_x1 - plane_x2) < 3 && fabs(plane_y1 - plane_y2) < 3)
				{
					sound_plane.stop();
				...
				if (fabs(shoot_x1 - plane_x2) < 3 && fabs(shoot_y1 - plane_y2) < 3 && shoot1)
				{
					sound_plane.stop();
				...
				if (fabs(shoot_x2 - plane_x1) < 3 && fabs(shoot_y2 - plane_y1) < 3 && shoot2)
				{
					sound_plane.stop();
					Badabum(plane_x1, plane_y1);
					plane_angle1 = -90;
